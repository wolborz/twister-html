...
if(preferredLanguage == "pl"){
    ...
    wordset = {
      ...
      "Direct Messages": "Direct Messages",
      "Disable": "Wyłącz",
      "Display mentions to @": "Wyświetlacz wskazuje na @",
      "Display retransmissions": "Wyświetl retransmisje",
      "DNS to obtain list of peers:": "DNS pokazuje liste peer'ów:",
      "downloading_block_chain": "Pobieranie łańcucha bloku, proszę czekać przed przejściem (łańcuch blokowy jest% {days} dni)",
      "download_posts_status": "Pobieram %{portion} portów", // Downloaded 10/30 posts
      "Enable": "Włacz",
      "error": "Błąd: %{error}",
      "error_connecting_to_daemon": "Błąd połączenia z lokalnym daemonem twistera.",
      ...
      "Generate blocks (send promoted messages)": "Wygenerowane bloki (send promoted messages)",
      "Home": "Strona główna", // homepage
      "hours": "%{smart_count} godzina |||| %{smart_count} godziny",
      "Internal error: lastPostId unknown (following yourself may fix!)": "Błąd wewnętrzny: nieznany  lastPostId (Śledzenie siebie może pomóc!)",
      "Known peers:": "Znane peery: ",
      "Last block is ahead of your computer time, check your clock.": "Ostatni blok jest do przodu z czasem. Sprawdź swój zegar.",
      "mentions_at": "Wzmianka u @%{user}",
      "minutes": "%{smart_count} munuta |||| %{smart_count} minuty",
      "Must be 16 characters or less.": "Musi mieć 16 znaków albo mniej.", // username
      "Network": "Sieć",
      "Network config": "Network config",
      "Network status": "Network status",
      "New direct message...": "New direct message...",
